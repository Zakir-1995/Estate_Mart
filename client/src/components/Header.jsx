  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-4 max-w-6xl mx-auto relative">
        <Link to="/">
          <img src="/EstateMart.png" alt="/" className="lg:w-36 md:w-34 sm:w-28 w-24" />
        </Link>
        <form
          onSubmit={handleSubmit}
          className="border border-gray-300 rounded p-2 md:flex items-center justify-between hidden "
        >
          <input
            type="text"
            placeholder="Search..."
