      ...
      <div className=" relative">
        ...
        <div className=" pb-5 sm:ml-[220px]">
          <div className="flex justify-center">
            <h1 className="md:text-2xl text-xl  font-semibold border-b border-gray-400 w-fit  pb-2 text-slate-700 mt-5">
              Listing results
            </h1>
          </div>

          <div className="px-5 flex flex-wrap items-center justify-center w-full gap-5 pt-5">
          ...
          {showMore && (
            <div className="flex justify-center mt-5">
              ...
              <button
                ...
                className="bg-green-700 shadow px-5 py-1 transition-all duration-100 ease-linear text-white rounded-full hover:bg-green-800 hover:shadow-md text-lg  text-center w-fit"
              >
                Show more {" >>"}
              </button>
            </div>
