...
const Profile = () => {
  ...
  return (
    <div className="mt-20 max-w-6xl mx-auto ">
      {confirmModal && (
        <div className="fixed top-0 left-0  w-full h-full  flex justify-center items-center z-50 bg-black/95 px-5">
          <ConfirmDelete
      ...
      <Helmet>
        <title>Estate Mart - Profile</title>
      </Helmet>
      <div className="flex flex-col  p-5 justify-center h-fit ">
            ...
            <div className="w-full flex flex-col gap-3 my-5">
              {listings?.length > 0 &&
                listings?.map((item) => (
                  <div
                    key={item?._id}
                    className="border border-gray-300 p-1 rounded flex items-center justify-between flex-wrap gap-4"
                  >
                    ...
                    <div className="space-x-2 flex items-center flex-nowrap">
